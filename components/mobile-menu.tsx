...
export function MobileMenu() {
  ...
  const menuItems = [
    { name: "Home", href: "/" },
    {
      ...
      hasDropdown: true,
      dropdownItems: [
        { name: "AFFORDABED", href: "/products?category=AFFORDABED" },
        { name: "Premium Beds", href: "/products?category=Premium" },
        { name: "Bunk Beds", href: "/products?category=Bunk+Beds" },
        { name: "Loft Beds", href: "/products?category=Loft+Beds" },
        { name: "Sofa Beds", href: "/products?category=Sofa+Beds" },
